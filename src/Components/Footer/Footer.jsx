            ...
            <div className="slide mx-auto">
                <div className="pb-5 mb-5 sm:pb-8 sm:mb-8 border-b border-b-white/10">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex gap-x-2 sm:gap-x-3">
                            <a href="https://www.instagram.com/hamedpyn" rel="nofollow">
                                <svg className="size-[30px] sm:size-[38px] text-neutral-300 dark:text-neutral-200 transition-colors hover:text-sky-500" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="flex  items-center flex-wrap gap-y-4  gap-x-12 mt-10 sm:mt-8">
                        <a href="tel:02191030926" className="flex items-center flex-grow md:flex-grow-0 gap-x-1 sm:gap-x-2 text-sm sm:text-base text-[#333c4c] dark:text-neutral-300 dana-regular">
                            <MdOutlineLocalPhone className="size-5 sm:size-6 mt-[-5px]" />
                            09155071931                        </a>
                        <a href="mailto:info@sabzlearn.ir" className="flex items-center flex-grow md:flex-grow-0 gap-x-1 sm:gap-x-2 text-sm sm:text-base text-[#333c4c] dark:text-neutral-300 dana-regular">
