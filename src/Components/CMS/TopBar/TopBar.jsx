...
export default function TopBar({ isUser, setIsCmsSideBar, userInfos }) {
    let { darkMode, setDarkMode } = useContext(SabzLearnContext)
            ...
            <div className={`border-b flex items-center pb-5 flex-wrap justify-between border-b-neutral-300 dark:border-b-white/10 ${isUser && "border-none dark:bg-[#242A38] p-3 pb-3 bg-white"}`}>
                ...
                <div className="lg:hidden">
                    <Link to={'/'} className="flex items-center gap-x-2 xl:pl-6 xl:ml-6">
                        <svg className="h-12 sm:h-15" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1065.8713 255.5117">
                ...
                <div className="hidden md:flex lg:flex-wrap lg:justify-between lg:w-full items-center gap-2">
                    ...
                    }} className="lg:flex hidden border border-neutral-300 dark:border-white/10 h-[52px] rounded-full w-[52px] items-center justify-center">
                    ...
                    <div className="flex flex-wrap-reverse items-end border-neutral-300 dark:border-white/10 w-auto gap-2 p-1 rounded-xl">
                        <div className="flex flex-col items-end">
                            <span className="dana-medium dark:text-white text-gray-900">{userInfos.name}</span>
                            <span className="dana-regular dark:text-white/60 text-gray-900/60">{userInfos.email}</span>
                        </div>
                        <img className="w-[52px] rounded-full" src={userInfos.profile || "/images/ba986f5ecace8be41dfdf99d3000078f.png"} alt="user image" />
                    </div>
                </div>
            </div>
        </div>
