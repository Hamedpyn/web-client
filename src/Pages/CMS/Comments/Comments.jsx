...
export default function Comments() {
    ...
    const getAllComments = useCallback(() => {
        fetch('https://educational-web-site.vercel.app/v1/comments')
            .then(res => res.json())
            .then(setComments)
    }, [])
    ...
    const removeComment = () => {
        fetch(`https://educational-web-site.vercel.app/v1/comments/${commentID}`, {
            method: 'DELETE',
            headers: {
    ...
    const BanUser = () => {
        fetch(`https://educational-web-site.vercel.app/v1/users/ban/${userID}`, {
            method: 'PUT',
            headers: {
                Authorization: `Bearer ${localStorageData.token}`
            },
    ...
    const acceptComment = () => {
        fetch(`https://educational-web-site.vercel.app/v1/comments/accept/${commentID}`, {
            method: 'PUT',
            headers: {
                Authorization: `Bearer ${localStorageData.token}`
            },
    ...
    const rejectComment = () => {
        fetch(`https://educational-web-site.vercel.app/v1/comments/reject/${commentID}`, {
            method: 'PUT',
            headers: {
                Authorization: `Bearer ${localStorageData.token}`
            },
