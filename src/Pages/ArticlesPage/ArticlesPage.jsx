...
export default function ArticlesPage() {
    ...
    useEffect(() => {
        fetch(`https://educational-web-site.vercel.app/v1/articles/${blog}`)
            .then(res => res.json())
            .then(articles => {
                if (articles) {
                        ...
                        <div className="col-span-12 mt-2 lg:col-span-8 xl:col-span-9">
                            <BoxesTitle bg={"bg-[#0EA5E9]"} title={articlesDetails.title} >
                                ...
                                <div className="rounded-2xl overflow-hidden mb-6">
                                    <img className="w-full" src={`https://educational-web-site.vercel.app/courses/covers/${articlesDetails.cover}`} alt="Articles Image" />
                                </div>
                                <div>
